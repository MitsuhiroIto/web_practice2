...
app = Flask(__name__)
app.config['FLASKS3_BUCKET_NAME'] = 'mitsu-web-app2'
...
def index():
    ...
    Params={'Bucket': 'mitsu-web-app2','Key': 'static/img/profile.jpg'})
...
def send():
    if request.method == 'POST':
        ...
        Params={'Bucket': 'mitsu-web-app2','Key':upload_s3_file_url })
        profile_name_url = boto3_client.generate_presigned_url(ClientMethod='get_object',
        Params={'Bucket': 'mitsu-web-app2','Key': 'static/img/profile.jpg'})
