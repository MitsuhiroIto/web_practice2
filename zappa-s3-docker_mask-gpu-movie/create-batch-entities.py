...
parser.add_argument("--container", help="container", type=str, default='251699169519.dkr.ecr.ap-northeast-1.amazonaws.com/mitsuhiro3116/mask_cuda8-6_opencv')
parser.add_argument("--image-id", help="image id", type=str, default='ami-868acfe0')
